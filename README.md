...
│       ├── comparacion\_tamano.png

│       ├── labels.txt

│       ├── mobilevit\_fase3\_final\_float16.tflite

│       ├── mobilevit\_fase3\_final\_float32.tflite

│       ├── mobilevit\_fase3\_mejor.pt

│       └── mobilevit\_final.onnx

│

├── 📊 resultados/

│   └── RESULTADOS\_FASE3\_TTA.zip
...
\* \*\*`comparacion\_tamano.png`\*\* — comparación del tamaño de los formatos generados.
...
👉 \*\*\[Acceder al material complementario en Google Drive](https://drive.google.com/drive/folders/1byUO8WokUW7XQ7aetZ6Z-FEei2Z1\_cgO?usp=sharing)\*\*
